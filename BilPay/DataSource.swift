...
public class dataSource {
    public static var userRecords: [NSManagedObject] = []
    public static var Data = ""
    public static var apiToken = ""
    public static var userID = ""
    public static var userName = ""
    public static var userEmail = ""
    public static var UserPublicKey = ""
    public static var UserCreatedAt = ""
    public static var UserUpdatedAt = ""
    public static var UserStellar = ""
}
